    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            for (int i = 0; i < numberOfOps; i++) {
                ...
                if(reply != null) {
                    long newValue = new DataInputStream(new ByteArrayInputStream(reply)).readLong();
