...
public class ServerConnection {
    ...
    public final void send(byte[] data, boolean useMAC) throws InterruptedException {
        if (useSenderThread) {
            ...
            if (!useMAC) {
                logger.info("Not sending defaultMAC " + System.identityHashCode(data));
            ...
            if (!outQueue.offer(data)) {
                ...
                logger.info("Inserted message into out queue for process {}.", remoteId);
            }
        } else {
            sendLock.lock();
    ...
    private class SenderThread extends Thread {
        ...
        public SenderThread() {
            super("SenderThread for " + remoteId);
        }
        ...
        public void run() {
            ...
            while (doWork) {
                ...
                if (data != null) {
                    ...
                    logger.info("Sending data " + (sendMAC ? "with" : "without") + " MAC (" + ref + ")");
                    sendBytes(data, sendMAC);
                }
            }

            logger.info("SenderThread for " + remoteId + " stopped!");
        }
    }
    ...
    protected class ReceiverThread extends Thread {
        ...
        public ReceiverThread() {
            super("ReceiverThread for " + remoteId);
        }
