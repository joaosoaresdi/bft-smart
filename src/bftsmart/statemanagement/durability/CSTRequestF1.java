...
public class CSTRequestF1 extends CSTRequest {
	...
	protected int logUpper;
	/** id of the replica responsible for sending the lower portion of the log;*/
	protected int logLower;
	protected int ckpPeriod;
	protected int logUpperSize;
	protected int logLowerSize;
	protected InetSocketAddress address;
	
	@Override
	public String toString() {
		return "CSTRequestF1 ["+ "cid=" + cid + ", checkpointReplica=" + checkpointReplica + ", logUpper=" + logUpper + ", logLower=" + logLower + ", ckpPeriod=" + ckpPeriod
	 ...
	 */
	protected int getOldest(int[] others, int cid, int globalCheckpointPeriod, int me) {
