...
public final class RequestContext{
	...
	public RequestContext(int reqId, int operationId, TOMMessageType requestType, int [] targets, 
		...
		public String toString() {
			return "RequestContext [reqId=" + reqId + ", operationId=" + operationId + ", requestType=" + requestType
					+ ", targets=" + Arrays.toString(targets) + ", sendingTime=" + sendingTime + ", replyListener="
					+ replyListener + ", request=" + Arrays.toString(request) + "]";
		}
