...
public class MessageContext implements Serializable {
	...
	public String toString() {
		return "MessageContext [sender=" + sender + ", viewID=" + viewID + ", type=" + type + ", session=" + session
				+ ", sequence=" + sequence + ", operationId=" + operationId + ", replyServer=" + replyServer
				+ ", signature=" + Arrays.toString(signature) + ", timestamp=" + timestamp + ", regency=" + regency
				+ ", leader=" + leader + ", consensusId=" + consensusId + ", numOfNonces=" + numOfNonces + ", seed="
				+ seed + ", proof=" + proof + ", firstInBatch=" + firstInBatch + ", lastInBatch=" + lastInBatch
				+ ", noOp=" + noOp + ", readOnly=" + readOnly + ", nonces=" + Arrays.toString(nonces) + "]";
	}
